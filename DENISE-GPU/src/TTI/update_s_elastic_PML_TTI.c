...
void update_s_elastic_PML_TTI(int nx1, int nx2, int ny1, int ny2,
	...
	if(!getenv("DENISE_GPU_DISABLE_TTI_S")){
		if(denise_gpu_update_s_aniso(nx1,nx2,ny1,ny2,vx,vy,ux,uy,uxy,
			sxx,syy,sxy,d11,d13,d15,d15h,d33,d35,d35h,d55h,hc,K_x,a_x,b_x,
			...
			NPROCX,NPROCY,POS[1],POS[2],GRAD_FORM,DT,DH,1)!=0)
			err("CUDA TTI stress update failed");
		return;
	}
#endif
