...
#ifdef DENISE_USE_CUDA
	if(!getenv("DENISE_GPU_DISABLE_PSV_SURFACE")){
	 if(denise_gpu_surface_psv(ndepth,NX,FDORDER,INVMAT1,FW,BOUNDARY,NPROCX,
	 POS[1],DT,DH,vx,vy,sxx,syy,sxy,pi,u,rho,hc,K_x,a_x,b_x,psi_vxx)!=0)
	 err("CUDA PSV free surface failed"); return;
	}
#endif
