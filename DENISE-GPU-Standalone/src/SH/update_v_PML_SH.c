...
#ifdef DENISE_USE_CUDA
	if(!getenv("DENISE_GPU_DISABLE_SH_V")){
	 if(denise_gpu_update_v_sh(nx1,nx2,ny1,ny2,vz,vzp1,sxz,syz,rhoi,hc,K_x,
	 a_x,b_x,K_y,a_y,b_y,psi_sxz_x,psi_syz_y,sw,FDORDER,FW,FREE_SURF,BOUNDARY,
	 NPROCX,NPROCY,POS[1],POS[2],GRAD_FORM,DT,DH)!=0)err("CUDA SH velocity update failed");
	 goto inject_sources_sh;
	}
#endif
